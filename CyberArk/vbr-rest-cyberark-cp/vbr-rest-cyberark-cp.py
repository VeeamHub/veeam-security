...
# Disable insecure request warnings - Do not use in productin environments
urllib3.disable_warnings(urllib3.exceptions.InsecureRequestWarning)

def retrieve_password(vbr_user, vbr_server, cy_app_id, cy_safe):
    cyberark_executable = r'C:\Program Files\CyberArk\ApplicationPasswordSdk\CLIPasswordSDK64.exe'
    ...
    command = [
        ...
        '/p', f'Query=Safe={cy_safe};Folder=Root;Object=Operating System-WinServerLocal-{vbr_server}-{vbr_user}',
        '/o', 'Password'
    ]
...
def refresh_cache():
    app_prv_mgr_executable = r'C:\Program Files\CyberArk\ApplicationPasswordProvider\AppPrvMgr.exe'
